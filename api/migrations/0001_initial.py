    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('victim_insights', models.TextField(help_text='Scam indicators found in analysis')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_mint_event', models.IntegerField(help_text='1 if Mint event included, 0 otherwise')),
                ('is_burn_event', models.IntegerField(help_text='1 if Burn event included, 0 otherwise')),
                ...
                ('reserve_base_drop_frac', models.FloatField(help_text='Base token decrease rate')),
                ('reserve_quote', models.DecimalField(decimal_places=18, help_text='Current major token balance', max_digits=78)),
                ('reserve_quote_drop_frac', models.FloatField(help_text='Major token decrease rate')),
                ('price_ratio', models.FloatField(help_text='Price ratio')),
                ('swap_sell_to_reserve_ratio', models.FloatField(help_text='Base token inflow ratio to reserve')),
                ('time_since_last_mint_sec', models.FloatField(help_text='Time elapsed since last Mint (seconds)')),
                ('price_ratio_delta_per_sec', models.FloatField(help_text='Price ratio change rate per second')),
                ('lp_supply_delta_per_sec', models.FloatField(help_text='LP supply decrease rate per second')),
                ('reserve_quote_delta_per_sec', models.FloatField(help_text='Major token balance decrease rate per second')),
                ('lp_minted_amount_per_sec', models.FloatField(help_text='LP minted amount per second')),
                ('lp_burned_amount_per_sec', models.FloatField(help_text='LP burned amount per second')),
                ('swap_base_in_amount_per_sec', models.FloatField(help_text='Base token inflow rate per second')),
                ('swap_base_out_amount_per_sec', models.FloatField(help_text='Base token outflow rate per second')),
                ('swap_quote_in_amount_per_sec', models.FloatField(help_text='Quote token inflow rate per second')),
                ('swap_quote_out_amount_per_sec', models.FloatField(help_text='Quote token outflow rate per second')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['token_info', 'event_time'], name='exit_proces_token_a_20e5db_idx'), models.Index(fields=['tx_hash'], name='exit_proces_tx_hash_e9854f_idx')],
            },
        ),
        migrations.CreateModel(
            name='HolderInfo',
